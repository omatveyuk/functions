...
def repeat_string(input_str, number):
    """Print string number times"""
    print input_str * number
...
def is_divisible_by_three(number):
    """Define if number is divisible by 3"""
    if number % 3 == 0:
        return True
    else:
        return False
...
def sign_and_parity(number):
    ...
    description = []
    description.append('Odd') if number % 2 != 0 else description.append('Even')
    description.append('Positive') if number >= 0 else description.append('Negative')
    return description
...
if __name__ == "__main__":
    ...
    print "Presentation of function sign_and_parity"
    print "My number is 3"
    parity, sign = sign_and_parity(3)
    print "Parity: ", parity, "; Sign: ", sign
